...
class FFNN():
	...
	def moment_based_gradient_descent(self, x_train, y_train, x_val, y_val):
	...
	def train(self, x_train, y_train, x_val, y_val):
		if self.optimizer == 'sgd':
			self.stochastic_gradient_descent(x_train, y_train, x_val, y_val)
		elif self.optimizer == 'mgd':
			self.moment_based_gradient_descent(x_train, y_train, x_val, y_val)
		elif self.optimizer == 'nag':
			self.nesterov_accelerated_gradient_descent(x_train, y_train, x_val, y_val)
		elif self.optimizer == 'rmsprop':
			self.rmsprop(x_train, y_train, x_val, y_val)
		elif self.optimizer == 'adam':
			self.adam(x_train, y_train, x_val, y_val)
		elif self.optimizer == 'nadam':
			self.nadam(x_train, y_train, x_val, y_val)
		return 0